    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top  py-6">
        ...
        <a class="navbar-brand" href="" id="brand">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <li class="nav-item">
                <a class="btn btn-primary py-3 px-3 d-flex justify-content-center align-items-center" href="index.php?page=login" role="button" id="iconlog"><i class="px-2 bi bi-person-circle"></i>Login</a>
                </li>
            </div>
        </div>
        </div>
